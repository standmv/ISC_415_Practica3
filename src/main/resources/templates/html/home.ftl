...
<title>POMPONEO Blog</title>

<link rel="stylesheet" href="/Users/StanDeMoya/Documents/GitHub/ISC_415_Practica3/src/main/resources/templates/css/bootstrap.css">
  ...
  <div class="container-fluid"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#">Crear una Publicacion</a> </li>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">Publicacion Destacada.</h1>
       ...
       <center> <img src="../images/1481644679592_1.jpg" alt="" class="img-responsive"> </center><hr>
       <div class="row">
          <div class="col-xs-12">
            <center><p><a class="btn btn-success btn-lg" href="#" role="button">Ir a la Publicacion</a> </p></center>
          </div>
        </div>
          </div>  
